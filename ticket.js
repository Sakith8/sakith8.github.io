...
submitbtn.addEventListener('click', (e) => {
    ...
    if (name && contactnum && Email) {
        window.alert(`Your Order has been confirmed ${name} on ${Date} .Your transaction order number will be send to ${contactnum} and ${Email}`)
        window.alert(`You have ordered ${totaltickets} and your total ticket price is ${totalcost}`)
    }
    else {
        window.alert(`Enter Personal Infromation and Submit`)
    }

})

//add to favourtie
addfavbut.addEventListener('click', (e) => {
